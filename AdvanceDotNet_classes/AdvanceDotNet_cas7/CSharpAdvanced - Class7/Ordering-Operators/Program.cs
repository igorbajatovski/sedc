...
namespace Ordering_Operators {
    class Program {
        ...
        static void Main(string[] args) {
            ...
            var alphabeticOrder = words.OrderBy(w => w);
            Console.WriteLine(string.Join(", ", alphabeticOrder));
            ...
            sortedProducts = products.OrderBy(p => p.CategoryID);
            Product.PrintProducts(sortedProducts);
            Console.WriteLine("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");

            sortedProducts = products.OrderBy(p => p.ProductID);
            Product.PrintProducts(sortedProducts);
            Console.WriteLine("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
