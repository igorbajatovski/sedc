...
namespace Exercise1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("---------- After removing parts from module -------------");
            m1.RemovePartFromModule(p1); //HDD
            m1.RemovePartFromModule(p6); //HDD usb cable
            Console.WriteLine("Module 1: {0}", m1.Name);
            Console.WriteLine(m1.GetPrice());
            Console.WriteLine(m1.GetPriceWithDiscount());
            Console.WriteLine(m1.GetPrice().PriceWithCurrency("EUR"));
            ...
            Console.WriteLine(m2.GetPriceWithDiscount());
            ...
            Console.WriteLine("---------- After removing parts/modules from configuration -------------");
            Console.WriteLine(pc1.Name);
            pc1.RemoveModuleFromProduct(m1);
            pc1.RemovePartFromProduct(p18); //Graphic card
            Console.WriteLine(pc1.GetPrice());
            pc1.SetDiscount(5); // 5%
            Console.WriteLine(pc1.GetPriceWithDiscount());
            Console.WriteLine(pc1.GetPrice().PriceWithCurrency("EUR"));
